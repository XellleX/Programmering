...
public class UI extends JFrame implements ActionListener
{
	...
	public void fillDefConstructor()
	{
		...
		pointInfo.setText("Kong (fyrtal)"
				...
				+ "\nPoäng till vinnaren"
				+ "\n• För Mah Jong (vinsten av spelet): 20p."
				+ "\n• För värdelös hand: 10p."
				+ "\n• För sprängd Kong: 10p."
				+ "\n• Om vinstbrickan är en av de lösa brickorna: 10p."
				+ "\n• Om vinstbrickan var den enda möjliga: 2p."
				+ "\n• Om vinstbrickan dras från muren: 2p.");
		doubling.setText("Dubbleringar"
				...
				+ "\nFöljande dubbleringar gäller endast för vinnaren:"
				+ "\n• Vinnaren för Mah Jong med den sista brickan från muren\n(Ruinens 14 brickor ska finnas kvar): 1 dubblering."
				+ "\n• Handen innehåller bara Vindar, Drakar, 1:or och 9:or: 1 dubblering."
				+ "\n• Handen innehåller inga följder (bara Pong och Kong): 1 dubblering."
				+ "\n• Handen innehåller brickor ur en serie, samt Vindar eller Drakar: 1 dubblering."
				+ "\n• Handen innehåller en Kong eller Pong av spelarens egna vindbrickor,\nvilka motsvarar Rondens vind: 2 dubbleringar."
				+ "\n• Handen innehåller grupper ur bara en serie: 3 dubbleringar."
				+ "\n• Handen innehåller två Pong av Drakar och en Pong av spelarens vindbrickor,\nsamtidigt som resterande brickor är ur en och samma serie: 4 dubbleringar."
				+ "\n• Handen innehåller en Pong av spelarens egna vindbrickor,\nsamtidigt som resterande brickor är ur en och samma serie: 5 dubbleringar.");
